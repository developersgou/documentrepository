...
@endif</h6>
 ...
 <li class="nav-item">
        <a class="nav-link " href="{{route('department.user-list')}}">
      <i class="bi bi-person-video"></i>
          <span>Users</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link " href="{{route('department.departmentlist')}}">
         ...
         <li class="nav-item">
        <a class="nav-link " href="{{route('department.user-mapping')}}">
     <i class="bi bi-diagram-3"></i>
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('department.document-list')}}">
              <i class="bi bi-circle"></i><span>Approved</span>
            </a>
          </li>
          <li>
            <a href="{{route('department.document-list-approval-pending')}}">
              <i class="bi bi-circle"></i><span>Pending</span>
            </a>
          </li>

          <li>
            <a href="{{route('department.document-trash-list')}}">
