...
@section("maincontent")
   ...
   <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <!-- Vertical Form -->
                 ...
                 <form class="row g-3" method="post" action="{{route('admin.documentlistupdate',[$document['id']])}}" autocomplete="off" enctype="multipart/form-data">
                       @csrf
                       @method("PUT")
                        <div class="col-6">
                        <label for="exampleInputName1" class="form-label">Document Number:</label>
                        <input type="text" class="form-control" id="" autofocus  name="doc_number" value="{{$document->doc_number}}">
                          @error("doc_number")
                        ...
                        <input type="text" class="form-control" id=""   name="doc_name" value="{{$document->doc_name}}">
                          @error("doc_name")
                            <div class="badge bg-danger">
                 ...
                 <div class="col-6">
                        ...
                        <input type="date" class="form-control" id=""   name="doc_approval_date" value="{{$document->doc_approval_date}}">
                        ...
                        <input type="text" class="form-control" id=""   name="doc_filename" value="{{$document->doc_filename}}">
                          @error("doc_filename")
                            <div class="badge bg-danger">
