...
@section("maincontent")
   ...
   <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <!-- Vertical Form -->
                 ...
                 <form class="row g-3" method="post" action="{{route('admin.departmentlistupdate',[$departmentlist['id']])}}" autocomplete="off">
                       @csrf
                       @method("PUT")
                        <div class="col-6">
                        <label for="exampleInputName1" class="form-label">Department Name:</label>
                        <input type="text" class="form-control" id="" autofocus  name="dep_name" value="{{$departmentlist->dep_name}}">
                          @error("dep_name")
