...
<section class="section">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
          <img src="{{asset('backend/assets/img/headerlogo.png')}}" alt="" id="responsive">
            ...
            <div class="col-md-6" style="padding-top: 30px;background-color:#fcfcff;">
               <img src="{{asset('backend/assets//img/logingif.gif')}}" width="700" height="400">
            </div>
            <div class="col-md-6" style="border: 1px solid #ced4da; margin-top: 5px;background-color:#fcfcff;">
                    <div class="d-flex justify-content-center py-4">
              <div class="pagetitle"><h4 style="color:navy;"><strong>SIGN UP</strong></h4></div> 
              </div><!-- End Logo -->
              
                                 <form class="row g-3" method="POST" action="{{ route('userreg') }}" autocomplete="off">
                                     @csrf
                                     ...
                                     <div class="col-md-6">
                                         ...
                                         <input id="" type="text" class="form-control" name="user_mobile"
                                             value="{{ old('user_mobile') }}">

                                         @error('user_mobile')
                                             <span class="badge bg-danger"><i
                                                     class="bi bi-exclamation-octagon me-1"></i>{{ $errors->first('user_mobile') }}</span>
                                         @enderror
                                     </div>
                                     ...
                                     <div class="alert alert-primary"> <p style="text-align: center;"> Your E-mail will be your Username.</p></div>
