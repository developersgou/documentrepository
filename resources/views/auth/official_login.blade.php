...
@section("title","SGOU|OFFICIAL LOGIN")
        ...
        <img src="/backend/assets/img/headerlogo.png" alt="" id="responsive">
            ...
            <div class="col-md-5" style="border: 1px solid #ced4da; margin-top: 5px;padding-bottom: 10px;background: #fcfcff;">
                    <div class="d-flex justify-content-center py-4">
                         <div class="pagetitle"><h4 style="color:navy;"><strong> OFFICIAL LOGIN</strong></h4></div> 
              
              </div><!-- End Logo -->

                <form method="POST" action="{{ route('postofficiallogin') }}" autocomplete="off" class="row g-3 needs-validation">
