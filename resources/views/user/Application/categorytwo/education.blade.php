 ...
 <span class="badge rounded-pill bg-danger">Step 4 <i class="bi bi-exclamation-octagon me-1"></i></span>
   ...
   <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <!-- Vertical Form -->
                 ...
                 <form class="row g-3" method="post" action="{{ route('user.cat-two-qualification') }}" autocomplete="off" enctype="multipart/form-data">
                       @csrf
    ...
    <TR>
      <TD><INPUT type="checkbox" name="chk"/></TD>
       ...
       <TD><select class="form-control" name="ac_course[]" value="{{old('ac_course')}}">
                      ...
                      <option value="Plus Two">Plus Two/Predegree</option>
