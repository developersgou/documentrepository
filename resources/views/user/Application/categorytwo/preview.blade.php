...
<span class="badge rounded-pill bg-danger">Step 4 <i class="bi bi-check-circle-fill"></i></span>
   ...
   <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <form class="row g-3" method="post" action="{{ route('user.submit-cat-two-application') }}" autocomplete="off" enctype="multipart/form-data">
                       @csrf
