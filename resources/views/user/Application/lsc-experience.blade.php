...
<span class="badge rounded-pill bg-danger">Step 5 <i class="bi bi-exclamation-octagon me-1"></i></span>
   ...
   <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <!-- Vertical Form -->
                 ...
                 <form class="row g-3" method="post" action="{{ route('user.lsc-experience') }}" autocomplete="off" enctype="multipart/form-data">
                       @csrf
 ...
 <input type="hidden"  value="{{$job_id}}" name="job_id">
    <div class="table-responsive">
         ...
         <h3 class="card-title">TEACHING EXPERIENCE</h3> <button class="btn btn-outline-success" type="button" onclick="addRow('dataTable')" ><i class="bi bi-plus-circle"></i></button>
...
<div class="col-12">
    ...
    <TR>
      ...
      <TD><input class="form-control" type="text" name="research_designation[]">
       ...
       <TD><input class="form-control" type="date" name="research_fromdate[]" >
   ...
   <TD><input class="form-control" type="date" name="research_todate[]" >
   ...
   <TD><input class="form-control" type="text" name="research_duration[]" >
...
<div class="col-12">
    <div class="table-responsive">
         ...
         <h3 class="card-title">AWARDS OR ACHIEVEMENTS</h3>

           <button class="btn btn-outline-success" type="button" onclick="addRow3('dataTable3')" ><i class="bi bi-plus-circle"></i></button>
           <button class="btn btn-outline-danger" type="button" onclick="deleteRow3('dataTable3')" ><i class="bi bi-trash-fill"></i></button> 
          <table class="table table-striped">
                <tr>
            <th></th>
            <th style="text-align: left;">Awarding Body</th>
            <th style="text-align: left;">Name of Award</th>
    ...
    <TR>
      <TD><INPUT type="checkbox" name="chk"/></TD>
       ...
       <TD><input  class="form-control" type="text" name="award_body[]">
        @error("award_body")
                           
                                <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>{{$errors->first("award_body")}}</span>
                            @enderror
   </TD>
      <TD><input class="form-control" type="text" name="award_name[]">
        @error("award_name")
                           
                                <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>{{$errors->first("award_name")}}</span>
                            @enderror
   </TD>
      <TD><input class="form-control" type="date" name="award_date[]">
        @error("award_date")
                           
                                <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>{{$errors->first("award_date")}}</span>
                            @enderror
   </TD>
     
       <TD><select class="form-control" name="award_level[]" value="{{old('award_level')}}">
        ...
        @error("award_level")
                                ...
                                <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>{{$errors->first("award_level")}}</span>
                            @enderror
   </TD>
...
<div class="col-12">  
   <h3 class="card-title">AREA OF INTEREST</h3>
   <div class="col-md-6">
                  <textarea id="area_interest" type="text" class="form-control" name="area_interest"  rows="6" value="{{old('area_interest')}}"></textarea>

                                 @error("area_interest")
                          
                                <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>{{$errors->first("area_interest")}}</span>
                            @enderror
                </div>
