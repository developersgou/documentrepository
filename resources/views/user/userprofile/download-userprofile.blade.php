...
<table style="width:80%">
  ...
  <tr>
    ...
    <td>{{$userdetails->fetchRegistrationTable->registation_id}}</td>
  </tr>
    <tr>
    <th>Email</th>
  ...
  @endphp 
    	<img src="data:image/jpg;base64,{{ base64_encode($generator->getBarcode($userdetails->fetchRegistrationTable->registation_id, $generator::TYPE_CODE_128)) }}" >
    <center>{{$userdetails->fetchRegistrationTable->registation_id}}</center>
