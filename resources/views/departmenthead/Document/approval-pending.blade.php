                        ...
                        <tr>
                          ...
                          <td colspan="2">
                            ...
                            <a href="{{asset($documents->doc_document)}}" target="_black" class="btn btn-outline-warning">Preview</a>
                             ...
                             <a href="{{route('department.documentstatuschange',[$documents['id'],'1'])}}" onclick="return confirm('Are you sure you want to approve.');" class="btn btn-outline-danger" id="">Approve</a>
