  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed " href="{{route('user.user-profile')}}">
     ...
     <li class="nav-item">
        ...
        <ul id="job-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('user.job-notificationlist')}}">
              <i class="bi bi-circle"></i><span>Job Notification List</span>
            </a>
          </li>
            <li>
            <a href="{{route('user.applied-job-notifications')}}">
              <i class="bi bi-circle"></i><span>Applied Notification List</span>
            </a>
          </li>
